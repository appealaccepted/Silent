...
oldIndex = hookmetamethod(game, "__index", function(self, Index)
	if self == Mouse and (Index == "Hit") then 
		...
		if Targete ~= nil and Targete[Options.Torso] and Targete[Options.Head] and Targete[Options.Upper] and Targete:FindFirstChild("Humanoid").Health > 0 then
			if SilentAim then
				local ShootThis = Targete[Options.Torso] and Targete[Options.Head] and Targete[Options.Upper] --and Targete[Options.Head] and Targete[Options.Upper]
